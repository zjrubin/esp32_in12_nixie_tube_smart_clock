...
#define EEPROM_NIXIE_SAVER_MODE_ADDRESS 4
#define EEPROM_NIXIE_SAVER_MODE_DEFAULT 0
#define EEPROM_NIXIE_SAVER_MODE_LOWER_BOUND 0
#define EEPROM_NIXIE_SAVER_MODE_UPPER_BOUND 1

#define EEPROM_SPECIAL_MODES_ADDRESS 5
#define EEPROM_SPECIAL_MODES_DEFAULT 0
#define EEPROM_SPECIAL_MODES_LOWER_BOUND 0
#define EEPROM_SPECIAL_MODES_UPPER_BOUND 1

#define EEPROM_NIXIE_SAVER_MODE_START_TIME_ADDRESS 8
#define EEPROM_NIXIE_SAVER_MODE_START_TIME_DEFAULT 0
#define EEPROM_NIXIE_SAVER_MODE_START_TIME_LOWER_BOUND 0
#define EEPROM_NIXIE_SAVER_MODE_START_TIME_UPPER_BOUND 23

#define EEPROM_NIXIE_SAVER_MODE_END_TIME_ADDRESS 9
#define EEPROM_NIXIE_SAVER_MODE_END_TIME_DEFAULT 6
#define EEPROM_NIXIE_SAVER_MODE_END_TIME_LOWER_BOUND 0
#define EEPROM_NIXIE_SAVER_MODE_END_TIME_UPPER_BOUND 23
